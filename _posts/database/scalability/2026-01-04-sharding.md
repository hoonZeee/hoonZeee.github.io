...
![모듈러 샤딩 다이어그램]({{ "/assets/images/database/sharding/modular_sharding.png" | relative_url }})
...
![레인지 샤딩 다이어그램]({{ "/assets/images/database/sharding/range_sharding.png" | relative_url }})
